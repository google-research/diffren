...
#ifndef DIFFREN_COMMON_KERNELS_RASTERIZE_TRIANGLES_IMPL_H_
#define DIFFREN_COMMON_KERNELS_RASTERIZE_TRIANGLES_IMPL_H_
...
#endif  // DIFFREN_COMMON_KERNELS_RASTERIZE_TRIANGLES_IMPL_H_
